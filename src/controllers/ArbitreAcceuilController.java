 ...
 * @author 
 */
public class ArbitreAcceuilController {
     private Main main;
    ...
    @FXML
    public void crMClicked() throws IOException {
        navigateTo("/views/ArbitreAcceuilWindow.fxml");
    }
    @FXML
    public void formation() throws IOException {
        navigateTo("/views/ArbitreAcceuilFormation.fxml");
